    ...
    >
      ...
      <div className="relative z-[2] max-w-6xl mx-auto px-6 text-center animate-fade-in">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
          Impresión offset y digital, diseño gráfico, rotulación, seriografía
          y papelería corporativa. Todo lo que tu negocio necesita para
          comunicar con impacto, desde Los Santos de Maimona hasta toda la
          comarca de Zafra y Badajoz.
        </p>
